...
# Known Problem 4: if the coordinates are not in the same UTM zone the program will still run even though it is not supposed to, the arcGIS project file does not change the projection.  
